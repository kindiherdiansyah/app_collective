...
class M_laporan extends CI_Model{
	...
	// 	return $hsl;
	// }
	function get_data_kolektif_perkodekolektor($kolektor_id){
		$hsl=$this->db->query("SELECT kolektif_id,nama_kantor,kode_kolektor,instansi,no_rek,nama,angsuran,sisa_kredit,tgk_angsuran,bln_thn  FROM tbl_kolektif WHERE kode_kolektor='$kolektor_id' ORDER BY kolektif_id ASC");
		return $hsl;
	}

	// function get_data_resi_pertanggal($tanggal){
	// 	$hsl=$this->db->query("SELECT resi_id,resi_number,DATE_FORMAT(created_date,'%d %M %Y')AS created_date FROM tbl_resi WHERE DATE(created_date)='$tanggal' ORDER BY resi_id DESC");
	// 	return $hsl;
	// }
	...
	function get_kode_kolektor(){
		$hsl=$this->db->query("SELECT DISTINCT kode_kolektor FROM tbl_kolektif");
		return $hsl;
	}

	// function get_bulan(){
	// 	$hsl=$this->db->query("SELECT DISTINCT DATE_FORMAT(created_date,'%M %Y') AS bulan FROM tbl_resi");
	// 	return $hsl;
	// }
	
	// function get_tahun(){
	// 	$hsl=$this->db->query("SELECT DISTINCT YEAR(created_date) AS tahun FROM tbl_resi");
	// 	return $hsl;
	// }
