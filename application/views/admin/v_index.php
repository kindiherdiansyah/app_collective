...
<body>
<img src="<?php echo base_url().'assets/img/an.png'?>" alt="gambar" class="bg" />
    <!-- Navigation -->
   <?php 
   ...
   ?>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header" style="color:#fcc;"><strong>Welcome to</strong>
                    <small><strong>Collective System</strong></small>
                </h1>
            </div>
        </div>
        <!-- /.row -->
